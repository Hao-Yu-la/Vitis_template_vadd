...
reg   [0:0] empty_25_reg_223;
reg   [0:0] empty_25_reg_223_pp0_iter1_reg;
...
wire   [0:0] empty_25_fu_135_p2;
reg   [31:0] m00_axi_output_buffer_load_reg_233;
reg    ap_condition_exit_pp0_iter1_stage0;
wire   [63:0] loop_index_cast3_fu_126_p1;
wire    ap_block_pp0_stage0_01001;
reg   [479:0] shiftreg_fu_62;
wire   [479:0] empty_23_fu_182_p3;
wire    ap_loop_init;
reg   [12:0] loop_index_fu_66;
reg   [12:0] ap_sig_allocacmp_loop_index_load;
wire   [12:0] empty_22_fu_120_p2;
wire   [3:0] empty_24_fu_131_p1;
wire   [447:0] tmp_1_fu_165_p4;
wire   [479:0] tmp_2_fu_175_p3;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (exitcond2_fu_114_p2 == 1'd0))) begin
            loop_index_fu_66 <= empty_22_fu_120_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            loop_index_fu_66 <= 13'd0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond2_fu_114_p2 == 1'd0))) begin
        empty_25_reg_223 <= empty_25_fu_135_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond2_reg_214 == 1'd0))) begin
        m00_axi_output_buffer_load_reg_233 <= m00_axi_output_buffer_q0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond2_fu_114_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond2_reg_214 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (empty_25_reg_223_pp0_iter1_reg == 1'd1) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (empty_25_reg_223_pp0_iter1_reg == 1'd1) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (*) begin
    ap_block_state3_io = ((empty_25_reg_223_pp0_iter1_reg == 1'd1) & (m_axi_m00_axi_WREADY == 1'b0));
end
...
assign empty_22_fu_120_p2 = (ap_sig_allocacmp_loop_index_load + 13'd1);

assign empty_23_fu_182_p3 = ((empty_25_reg_223_pp0_iter1_reg[0:0] == 1'b1) ? 480'd0 : tmp_2_fu_175_p3);

assign empty_24_fu_131_p1 = ap_sig_allocacmp_loop_index_load[3:0];

assign empty_25_fu_135_p2 = ((empty_24_fu_131_p1 == 4'd15) ? 1'b1 : 1'b0);

assign exitcond2_fu_114_p2 = ((ap_sig_allocacmp_loop_index_load == 13'd4096) ? 1'b1 : 1'b0);

assign loop_index_cast3_fu_126_p1 = ap_sig_allocacmp_loop_index_load;

assign m00_axi_output_buffer_address0 = loop_index_cast3_fu_126_p1;
...
assign m_axi_m00_axi_WDATA = {{m00_axi_output_buffer_load_reg_233}, {shiftreg_fu_62}};
...
assign tmp_1_fu_165_p4 = {{shiftreg_fu_62[479:32]}};

assign tmp_2_fu_175_p3 = {{m00_axi_output_buffer_load_reg_233}, {tmp_1_fu_165_p4}};
