...
reg   [0:0] exitcond64_reg_203;
reg   [0:0] empty_30_reg_207;
reg    ap_predicate_op24_read_state2;
reg    ap_block_state2_pp0_stage0_iter1;
wire    ap_block_state3_pp0_stage0_iter2;
reg    ap_block_pp0_stage0_subdone;
wire   [0:0] exitcond64_fu_114_p2;
...
reg   [12:0] loop_index4_load_reg_198;
reg   [12:0] loop_index4_load_reg_198_pp0_iter1_reg;
reg   [0:0] exitcond64_reg_203_pp0_iter1_reg;
wire   [0:0] empty_30_fu_130_p2;
reg   [0:0] empty_30_reg_207_pp0_iter1_reg;
reg   [511:0] m00_axi_addr_read_reg_211;
reg    ap_condition_exit_pp0_iter1_stage0;
reg   [511:0] ap_phi_mux_empty_27_phi_fu_91_p4;
wire   [511:0] ap_phi_reg_pp0_iter2_empty_27_reg_88;
wire   [511:0] shiftreg9_cast_fu_150_p1;
wire   [63:0] loop_index4_cast2_fu_155_p1;
reg   [479:0] shiftreg9_fu_56;
wire    ap_loop_init;
reg   [12:0] loop_index4_fu_60;
reg   [12:0] ap_sig_allocacmp_loop_index4_load;
wire   [12:0] empty_26_fu_120_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (exitcond64_fu_114_p2 == 1'd0))) begin
            loop_index4_fu_60 <= empty_26_fu_120_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            loop_index4_fu_60 <= 13'd0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            shiftreg9_fu_56 <= 480'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            shiftreg9_fu_56 <= {{ap_phi_mux_empty_27_phi_fu_91_p4[511:32]}};
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond64_fu_114_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond64_fu_114_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
always @ (*) begin
    if (((exitcond64_reg_203 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
always @ (*) begin
    if ((exitcond64_reg_203_pp0_iter1_reg == 1'd0)) begin
        if ((empty_30_reg_207_pp0_iter1_reg == 1'd0)) begin
            ap_phi_mux_empty_27_phi_fu_91_p4 = shiftreg9_cast_fu_150_p1;
        end else if ((empty_30_reg_207_pp0_iter1_reg == 1'd1)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0))) begin
        ap_sig_allocacmp_loop_index4_load = 13'd0;
    end else begin
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_predicate_op24_read_state2 == 1'b1) & (m_axi_m00_axi_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_predicate_op24_read_state2 == 1'b1) & (m_axi_m00_axi_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((ap_predicate_op24_read_state2 == 1'b1) & (m_axi_m00_axi_RVALID == 1'b0));
end
...
assign ap_phi_reg_pp0_iter2_empty_27_reg_88 = 'bx;

always @ (*) begin
    ap_predicate_op24_read_state2 = ((empty_30_reg_207 == 1'd1) & (exitcond64_reg_203 == 1'd0));
end

assign empty_26_fu_120_p2 = (ap_sig_allocacmp_loop_index4_load + 13'd1);

assign empty_29_fu_126_p1 = ap_sig_allocacmp_loop_index4_load[3:0];

assign empty_30_fu_130_p2 = ((empty_29_fu_126_p1 == 4'd0) ? 1'b1 : 1'b0);

assign exitcond64_fu_114_p2 = ((ap_sig_allocacmp_loop_index4_load == 13'd4096) ? 1'b1 : 1'b0);

assign loop_index4_cast2_fu_155_p1 = loop_index4_load_reg_198_pp0_iter1_reg;

assign m00_axi_input_buffer_address0 = loop_index4_cast2_fu_155_p1;

assign m00_axi_input_buffer_d0 = ap_phi_mux_empty_27_phi_fu_91_p4[31:0];
...
assign shiftreg9_cast_fu_150_p1 = shiftreg9_fu_56;
