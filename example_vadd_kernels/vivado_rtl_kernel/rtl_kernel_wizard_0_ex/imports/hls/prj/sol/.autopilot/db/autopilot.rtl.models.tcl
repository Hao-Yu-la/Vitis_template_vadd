set SynModuleInfo {
  ...
  {SRCNAME rtl_kernel_wizard_0 MODELNAME rtl_kernel_wizard_0 RTLNAME rtl_kernel_wizard_0 IS_TOP 1
    SUBMODULES {
      {MODELNAME rtl_kernel_wizard_0_m00_axi_input_buffer RTLNAME rtl_kernel_wizard_0_m00_axi_input_buffer BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
      ...
      {MODELNAME rtl_kernel_wizard_0_m00_axi_m_axi RTLNAME rtl_kernel_wizard_0_m00_axi_m_axi BINDTYPE interface TYPE interface_m_axi}
    }
  }
}
