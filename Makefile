...
EXECUTABLE = $(VER).exe
HOST_CL_SRCS += host_src/host_cl.cpp
HOST_CL_HDRS +=  
HOST_XRT_SRCS += host_src/host_xrt.cpp
HOST_XRT_HDRS += 

BINARY_CONTAINERS += $(XCLBIN)/$(KERNEL_NAME).$(TARGET).xclbin
BINARY_CONTAINER_OBJS += example_vadd_kernels/src/vitis_rtl_kernel/rtl_kernel_wizard_0/rtl_kernel_wizard_0.xo
